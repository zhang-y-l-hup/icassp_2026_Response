...
####  The quantitative comparison results of <font color="blue">SSIM/PSNR/LPIPS</font> across all scenarios under normal illumination conditions are presented in the following table.(Note: **$\textcolor{red}{Red}$  font indicates the optimal metric value.**)

|            |                         bicycle                          |                          bonsai                          |                           counter                            |                          garden                          |
| :--------: | :------------------------------------------------------: | :------------------------------------------------------: | :----------------------------------------------------------: | :------------------------------------------------------: |
|    3DGS    |                    0.771/25.246/0.205                    |                    0.938/31.980/0.205                    |                      0.905/28.700/0.204                      |                    0.868/27.410/0.103                    |
| ---------- |                        ----------                        |                        ----------                        |                          ----------                          |                        ----------                        |
|  Pixel-GS  |          0.793/25.739/$\textcolor{red}{0.173}$           |          0.951/$\textcolor{red}{32.697}$/0.162           |                      0.921/29.299/0.162                      |          0.878/27.834/$\textcolor{red}{0.094}$           |
| ---------- |                        ----------                        |                        ----------                        |                          ----------                          |                        ----------                        |
|    Ours    | $\textcolor{red}{0.808}$/$\textcolor{red}{26.365}$/0.204 | $\textcolor{red}{0.955}$/32.183/$\textcolor{red}{0.057}$ | $\textcolor{red}{0.920}$/$\textcolor{red}{29.373}$/$\textcolor{red}{0.080}$ | $\textcolor{red}{0.893}$/$\textcolor{red}{28.549}$/0.096 |

|            |                           kitchen                            |                             room                             |                            stump                             |
| :--------: | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
|    3DGS    |                      0.922/30.317/0.129                      |                      0.914/30.632/0.220                      |                      0.775/26.550/0.210                      |
| ---------- |                          ----------                          |                          ----------                          |                          ----------                          |
|  Pixel-GS  |                      0.936/31.956/0.106                      |                      0.930/31.794/0.183                      | $\textcolor{red}{0.796}$/$\textcolor{red}{27.111}$/$\textcolor{red}{0.181}$ |
| ---------- |                          ----------                          |                          ----------                          |                          ----------                          |
|    Ours    | $\textcolor{red}{0.954}$/$\textcolor{red}{32.107}$/$\textcolor{red}{0.041}$ | $\textcolor{red}{0.950}$/$\textcolor{red}{32.115}$/$\textcolor{red}{0.064}$ |                      0.787/26.518/0.211                      |
